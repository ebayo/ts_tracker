...
class YOLOv5:
    def __init__(self, weights, hyp, image_size=640):
        # TODO: see what happens with map_location
        # from yolov5/models/experimental.py>attempt_load()
        self.model = torch.load(weights)['model'].float().fuse().eval()
        print(self.model)
    ...
    def inference(self, img):
        ...
        # Apply NMS
        # we can filter by classes
        predictions = non_max_suppression(predictions, self.nms_th, self.iou_th)
